...
>b: KAEZstd, KAELz4, and KAESnappy can only be used on the new Kunpeng 920 processor model and Kunpeng 950 processor. Encryption and compression algorithms vary with processor models. For details, see [Algorithm Specifications](../../README_EN.md#supported-algorithms-and-specifications).<br>
...
|--|--|--|
|KAE 2.0|openEuler 22.03 LTS SP1/SP2/SP3/SP4, openEuler 24.03 LTS SP1/SP2/SP3, EulerOS V2.0 SP12, and TencentOS 5.4|OpenSSL 1.1.1x, OpenSSL 3.0.x, Tongsuo 8.4.0, and BoringSSL|
|KAE 1.0|CentOS 7.6 4.14.0-115.el7a.0.1.aarch64, SUSE 15.1 4.12.14-195-default.aarch64, EulerOS 2.8 4.19.36-vhulk1907.1.0.h410.eulerosv2r8.aarch64, NeoKylin 7.6 4.14.0-115.5.1.el7a.06.aarch64, BCLinux-R7-U6-Server-aarch64, Kylin 4.0.2 (juniper) 4.15.0-70-generic, Kylin release 4.0.2 (SP2) 4.19.36-vhulk1907.1.0.h403.ky4.aarch64, UniKylin Linux release 3(Core) 4.18.0-80.ky3.kb21.hw.aarch64, Ubuntu 18.04.1 LTS 4.15.0-29-generic, openEuler 20.03 LTS 4.19.90-2003.4.0.0036.oe1.aarch64, and openEuler 20.03 LTS SP1 4.19.90-2012.4.0.0053.oe1.aarch64|OpenSSL 1.1.1x|
