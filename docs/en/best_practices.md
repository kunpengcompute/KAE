...
For details, see [MySQL KAEZstd Page Compression and Decompression Optimization Feature Guide](https://www.hikunpeng.com/document/detail/en/boostdb/mysql/basic_computation_opt/docs/en/crc32_instruction_optimization_feature_guide.md).
