...
// static size_t write_outputFile_2(const char* outFileName, void* output, size_t output_size)
// {
...
//         return 0;
//     }
//     size_t count = fwrite(output, 1, output_size, outputFile);
//     fclose(outputFile);
//     return count;
// }
...
int test_async_frame_with_perferences_0()
{
    return test_async_frame_with_perferences(0, 0, 0);
}

int test_async_frame_with_perferences_1()
{
    return test_async_frame_with_perferences(1, 0, 0);
}
int test_async_frame_with_perferences_2()
{
    return test_async_frame_with_perferences(0, 1, 0);
}
int test_async_frame_with_perferences_3()
{
    return test_async_frame_with_perferences(0, 0, 1);
}
int test_async_frame_with_perferences_4()
{
