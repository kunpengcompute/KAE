...
free_data:
	...
	dh_free_eng_session(dh_sess);
soft_log:
	fprintf(stderr, "uadk_e_dh_generate_key switch to execute openssl software calculation.\n");
exe_soft:
...
free_data:
	...
	dh_free_eng_session(dh_sess);
soft_log:
	fprintf(stderr, "uadk_e_dh_compute_key switch to execute openssl software calculation.\n");
exe_soft:
