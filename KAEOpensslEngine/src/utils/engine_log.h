...
#define KAEOpensslEngine_CRYPTO(LEVEL, fmt, args...)                                                                     \
    do {                                                                                                \
...
#define US_ERR(fmt, args...)          KAEOpensslEngine_CRYPTO(KAE_ERROR, fmt, ##args)
#define US_WARN(fmt, args...)         KAEOpensslEngine_CRYPTO(KAE_WARNING, fmt, ##args)
#define US_INFO(fmt, args...)         KAEOpensslEngine_CRYPTO(KAE_INFO, fmt, ##args)
#define US_DEBUG(fmt, args...)        KAEOpensslEngine_CRYPTO(KAE_DEBUG, fmt, ##args)
