...
static cipher_info_t g_sec_ciphers_info[] = {
	...
	{NID_aes_128_cfb128, 1, 16, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	{NID_aes_192_cfb128, 1, 24, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	{NID_aes_256_cfb128, 1, 32, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	{NID_aes_128_ofb128, 1, 16, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	{NID_aes_192_ofb128, 1, 24, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	{NID_aes_256_ofb128, 1, 32, 16, EVP_CIPH_CTR_MODE, 1, NULL},
	...
	{NID_sms4_cfb128, 1, 16, 16, EVP_CIPH_CFB_MODE, 1, NULL},
...
#ifdef KAE_GMSSL
	case NID_sms4_ctr:
		cipher = (EVP_CIPHER *)EVP_sms4_ctr();
		break;
	case NID_sms4_cbc:
		cipher = (EVP_CIPHER *)EVP_sms4_cbc();
		break;
	case NID_sms4_ofb128:
		cipher = (EVP_CIPHER *)EVP_sms4_ofb();
		break;
	case NID_sms4_cfb128:
		cipher = (EVP_CIPHER *)EVP_sms4_cfb();
		break;
	case NID_sms4_ecb:
