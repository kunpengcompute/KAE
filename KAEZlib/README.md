...
## Statement
This code repository is intended to participate in the open-sourcing of the Zlib software, solely for the purpose of improving Zlib performance. The coding style follows that of the native open-source software, inheriting its security design without compromising the original architecture, coding style, or implementation approach. Any vulnerabilities or security issues in the software shall be addressed by the respective upstream community through its established vulnerability and security response mechanisms. Please closely monitor announcements and version updates released by the upstream community. The Kunpeng Computing Community assumes no responsibility for any vulnerabilities or security issues in the software.