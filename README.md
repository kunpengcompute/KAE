...
lrwxrwxrwx. 1 root root      12 Aug 22 17:28 kae.so -> kae.so.2.0.3
lrwxrwxrwx. 1 root root      12 Aug 22 17:28 kae.so.2 -> kae.so.2.0.3
-rwxr-xr-x. 1 root root 1967736 Aug 22 17:28 kae.so.2.0.3
```
...
linux-vdso.so.1 (0x0000ffffb0282000)
        ...
        libkaezip.so.2.0.3 => /usr/local/kaezip/lib/libkaezip.so.2.0.3 (0x0000ffffb0044000)
